			...
			<div id="container">
				...
				<div id="navigation">
					<ul class="nav" id="nav">
						...
						<li>
							<a class="navlink">External Links</a>
							<ul>
								<li><a href="https://github.com/bit286/bit562" target="repo">Blessed Github Repository</a></li>
								<li>
									<a class="sub">Network Repositories</a>
									<ul>									
										<li class="topline">
										...
										<li>
											<a href="https://github.com/tfinnell/bit562" target="repo">Tim<br />(Grand Git Guru)</a>
										</li>
										<li>
